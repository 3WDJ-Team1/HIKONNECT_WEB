<template>
    <div>
        <h2 style="font-family: 'Do Hyeon', sans-serif;">黄色い線をクリックして <br> 経路を作ります。</h2>
        ...
        <span style="font-size: 20px; font-family: 'Do Hyeon', sans-serif; color: yellow;">※経路がクリックできない場合マップを拡大して <br>正しい位置をクリックしてください。</span>

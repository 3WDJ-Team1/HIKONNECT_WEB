...
class EntryInfo extends Model
{
    ...
    public function getAppliedUsers(String $groupUuid)
    {
        ...
        ->select('user_profile.user', 'user_profile.nickname', 'user_profile.image_path', 'user_profile.phone', 'user_profile.gender', 'user_profile.age_group', 'user_profile.scope')
